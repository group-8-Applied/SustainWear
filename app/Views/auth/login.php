	...
	<div class="min-h-screen grid place-items-center p-7">
		<div class="w-full max-w-[420px] bg-white rounded-[14px] shadow-[0_12px_30px_rgba(2,8,20,.06)] p-[22px] pb-[26px]">
			...
			<div class="grid grid-cols-2 gap-[6px] mb-[10px]">
				<button id="tab-login" class="bg-[#008533] text-white border-0 rounded-[10px] p-[10px] font-bold text-center cursor-pointer" type="button">Log In</button>
			...
			<form action="/login" method="POST" class="grid gap-[10px] mt-[12px]">
				...
				<button class="inline-block border-0 rounded-[10px] py-[12px] px-[14px] font-semibold cursor-pointer bg-[#0A6CFF] text-white hover:bg-[#0A6CFF] mt-2" type="submit">Proceed</button>
			</form>
