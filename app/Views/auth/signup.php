...
<body class="m-0 h-full bg-[#f5f7fb] text-gray-900 font-sans">
	<div class="min-h-screen grid place-items-center p-7">
		<div class="w-full max-w-[420px] bg-white rounded-[14px] shadow-[0_12px_30px_rgba(2,8,20,.06)] p-[22px] pb-[26px]">
			<h1 class="text-center text-[#008533] my-[6px_0_14px] mb-[14px] mt-[6px] font-extrabold tracking-[0.3px] text-2xl">SustainWear</h1>
			...
			<div class="grid grid-cols-2 gap-[6px] mb-[10px]">
				...
				<button id="tab-signup" class="bg-[#008533] text-white border-0 rounded-[10px] p-[10px] font-bold text-center cursor-pointer" type="button">Sign Up</button>
			</div>
			...
			<form action="/signup" method="POST" class="grid gap-[10px] mt-[12px]">
				...
				<button class="inline-block border-0 rounded-[10px] py-[12px] px-[14px] font-semibold cursor-pointer bg-[#0A6CFF] text-white hover:bg-[#0A6CFF] mt-2" type="submit">Create Account</button>
			</form>

			<?php if (!empty($statusMessage)): ?>
				<p class="text-[#EB000C] text-center mt-4">
